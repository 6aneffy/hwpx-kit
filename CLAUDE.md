...
CLI (cli.py) — JSON 봉투, 종료코드 0/1/2
 └─ commands/ (analyze·fill·fill-batch·inspect·read·validate·convert·export·render·generate·fmt·image-add·header-footer·row-add·row-del·row-height·cell-merge·cell-split·cell-color·col-width·table-clear·table-set·table-copy·table-map·table-new·page-break·outline)
